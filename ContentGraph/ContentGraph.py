...
from TextAnalysis import TextRank


# nlp = spacy.load('en_core_web_lg')

nlp = spacy.load("C:\\Users\\stanDev\\ANACONDA\\envs\\Lemongraph37\\Lib\\site-packages\\en_core_web_lg\\en_core_web_lg-2.2.5")
...
class ContentMining():
    ...
    def __init__(self):
        ...
        self.graph_visualizer = GraphDisplay()
    ...
    def main(self, content):
        ...
        # 08 show event graph
        self.graph_visualizer.create_page(events)
